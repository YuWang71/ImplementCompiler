...
class Scanner {
    ...
    public TokenInfo getNextToken() {
        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                if(ch == '*'){
                    ...
                    if (ch == EOFCH && !MultiComments){
                        reportScannerError("Need a end-symbol for MultiComments");
                    }

                }
                else if (ch =='='){
                    nextCh();
                    return new TokenInfo(DIV_EQUAL,line);                
                }
                else if (ch == '/') {
        ...
        case '*':
            ...
            if(ch == '=')
                {   nextCh();
                    return new TokenInfo(MULTI_EQUAL,line);}
            else {
        ...
        case '%':
            ...
            if(ch == '='){
                nextCh();
                return new TokenInfo(REM_EQUAL, line);
            }            
            else{
        ...
        case '|':
            nextCh();
            if(ch == '='){nextCh(); return new TokenInfo(BOR_EQUAL,line);}
            else if( ch == '|') {nextCh(); return new TokenInfo(LOR,line);}
                 else {return new TokenInfo(BOR,line);} 
        case '^':
            nextCh();
            if(ch == '='){
                nextCh();
                return new TokenInfo(POW_EQUAL,line);       
            }
        ...
        case '-':
            ...
            if (ch == '-') {
                ...
                nextCh();
                return new TokenInfo(MIN_EQUAL,line);
            }            
            else {
        ...
        case '&':
            nextCh();
            if(ch == '=') {nextCh();return new TokenInfo(BAND_EQUAL,line);}
            else if (ch == '&') {
                        nextCh();
                        return new TokenInfo(LAND, line);} 
                 else { return new TokenInfo(BAND, line);}
        case '>':
            nextCh();
            if(ch =='=') { nextCh(); return new TokenInfo(GT_EQUAL,line);}  
            else if (ch == '>'){nextCh();
                                if(ch == '=') {nextCh(); return new TokenInfo(ARS_EQUAL,line);}
                                else if(ch =='>') {nextCh();
                                                   if (ch == '=')         
                                                        {nextCh(); return new TokenInfo(LRS_EQUAL,line);}
                                                   else {return new TokenInfo (LRS,line);}}
                                      else {return new TokenInfo(ARS,line);}}  
                  else {new TokenInfo(GT,line);}    
        case '<':
            nextCh();
            if(ch =='='){ nextCh(); return new TokenInfo(LE, line);}
            else if (ch == '<') {
                        nextCh(); 
                        if(ch =='=')  {nextCh(); return new TokenInfo(ALS_EQUAL,line);}
                        else {return new TokenInfo(ALS,line); }
                        } else { return new TokenInfo(LESS,line);}           
        case '\'':
