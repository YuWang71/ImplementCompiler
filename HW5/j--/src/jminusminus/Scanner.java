...
class Scanner {
    ...
    public TokenInfo getNextToken() {
        ...
        case '|':
            nextCh();
            if(ch == '='){nextCh(); return new TokenInfo(BOR_ASSIGN,line);}
        ...
        case '&':
            nextCh();
            if(ch == '=') {nextCh();return new TokenInfo(BAND_ASSIGN,line);}
            else if (ch == '&') {
                        nextCh();
        ...
        case '>':
            nextCh();
            if(ch =='=') { nextCh(); return new TokenInfo(GE,line);}  
            else if (ch == '>'){nextCh();
                                if(ch == '=') {nextCh(); return new TokenInfo(ARS_ASSIGN,line);}
                                else if(ch =='>') {nextCh();
                                                   if (ch == '=')         
                                                        {nextCh(); return new TokenInfo(LRS_ASSIGN,line);}
        ...
        case '<':
            ...
            if(ch =='='){ nextCh(); return new TokenInfo(LE, line);}
                        ...
                        nextCh(); 
                        if(ch =='=')  {nextCh(); return new TokenInfo(ALS_ASSIGN,line);}
