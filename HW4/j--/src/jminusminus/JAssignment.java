...
/////   LRS_ASSIGN(">>>=")  /////
class JUnsignRShiftAssignOp extends JAssignment {

    public JUnsignRShiftAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>>=", lhs, rhs);
    }
...
//////  BXOR_ASSIGN("^=")   ///////
class JCaretAssignOp extends JAssignment {

    public JCaretAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "^=", lhs, rhs);
    }
