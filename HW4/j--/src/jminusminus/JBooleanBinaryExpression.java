...
////////////    LogicalOrOp (Modify from LogicalAndOp)   //////////
...
/////////// Logical Not Equal   /////////////////
class JLogicalNotEqualOp extends JBooleanBinaryExpression {

   public JLogicalNotEqualOp (int line, JExpression lhs, JExpression rhs){
        super (line, "!=",lhs,rhs);    
    }
